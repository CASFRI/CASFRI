...
SELECT TT_Prepare('translation', 'nl_nli01_lyr', '_nl_nli01_lyr_test', 'ab_avi01_lyr');
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'nb03', 1, 'nb', 1, 1100, NULL, 'lyr'); -- Generates about 700 (731) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_nb_lyr_test('rawfri', 'nb03_l1_to_nb_l1_map_1100_lyr');
------------------------
SELECT TT_CreateMappingView('rawfri', 'nb03', 2, 'nb', 1, 1100, NULL, 'lyr'); -- Generates about 300 (301) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_nb_lyr_test('rawfri', 'nb03_l2_to_nb_l1_map_1100_lyr');
------------------------
SELECT TT_CreateMappingView('rawfri', 'nb06', 1, 'nb', 1, 1100, NULL, 'lyr'); -- Generates about 700 (731) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_nb_lyr_test('rawfri', 'nb06_l1_to_nb_l1_map_1100_lyr');
------------------------
SELECT TT_CreateMappingView('rawfri', 'nb06', 2, 'nb', 1, 1100, NULL, 'lyr'); -- Generates about 300 (301) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_nb_lyr_test('rawfri', 'nb06_l2_to_nb_l1_map_1100_lyr');
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc14', 2, 'bc', 1, 9000, NULL, 'lyr'); -- Generates about 300 (335) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_bc_lyr_test('rawfri', 'bc14_l2_to_bc_l1_map_9000_lyr');
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc15', 2, 'bc', 1, 7500, NULL, 'lyr'); -- Generates about 300 (315) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_bc_lyr_test('rawfri', 'bc15_l2_to_bc_l1_map_7500_lyr');
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc16', 2, 'bc', 1, 8000, NULL, 'lyr'); -- Generates about 300 (355) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_bc_lyr_test('rawfri', 'bc16_l2_to_bc_l1_map_8000_lyr');
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc18', 2, 'bc', 1, 8150, NULL, 'lyr'); -- Generates about 300 (311) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_bc_lyr_test('rawfri', 'bc18_l2_to_bc_l1_map_8150_lyr');
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'sk07', 1, 'sk_utm', 1, 900, NULL, 'lyr'); -- Generates about 700 (659) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_sk_utm_lyr_test('rawfri', 'sk07_l1_to_sk_utm_l1_map_900_lyr');
------------------------
SELECT TT_CreateMappingView('rawfri', 'sk07', 2, 'sk_utm', 1, 80000, NULL, 'lyr'); -- Generates about 700 (727) LYR rows
INSERT INTO casfri50_test.lyr_all_new
SELECT * FROM TT_Translate_sk_utm_lyr_test('rawfri', 'sk07_l2_to_sk_utm_l1_map_80000_lyr');
------------------------
