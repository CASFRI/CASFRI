...
SELECT TT_Prepare('translation', 'nl_nli01_dst', '_nl_nli01_dst_test', 'ab_avi01_dst', FALSE);
SELECT TT_Prepare('translation', 'nl_nli02_dst', '_nl_nli02_dst_test', 'ab_avi01_dst', FALSE);
------------------------
...
------------------------
-- SELECT *
-- FROM TT_CheckNumberOfTests('dst', 'nl', TRUE)
