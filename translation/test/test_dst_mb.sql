...
SELECT TT_Prepare('translation', 'mb_fri01_dst', '_mb_fri_dst_test', 'ab_avi01_dst', FALSE);
SELECT TT_Prepare('translation', 'mb_fli01_dst', '_mb_fli_dst_test', 'ab_avi01_dst', FALSE);
------------------------
...
/*
SELECT * 
FROM TT_CheckNumberOfTests('dst', 'mb', TRUE)
