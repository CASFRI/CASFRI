...
SELECT TT_Prepare('translation', 'ds_cfs01_cas', '_ds_cfs_cas_test', 'ab_avi01_cas', FALSE);
SELECT TT_Prepare('translation', 'ds_bea01_cas', '_ds_bea_cas_test', 'ab_avi01_cas', FALSE);
------------------------
