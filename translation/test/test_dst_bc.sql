...
SELECT TT_Prepare('translation', 'bc_vri01_dst', '_bc_dst_test', 'ab_avi01_dst', FALSE);
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc14', 1, 'bc', 1, 2800, NULL, 'dst'); -- Generates about 900 (935) DST rows
INSERT INTO casfri50_test.dst_bc_new
SELECT * FROM TT_Translate_bc_dst_test('rawfri', 'bc14_l1_to_bc_l1_map_2800_dst');
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc15', 1, 'bc', 1, 2900, NULL, 'dst'); -- Generates about 900 (940) DST rows
INSERT INTO casfri50_test.dst_bc_new
SELECT * FROM TT_Translate_bc_dst_test('rawfri', 'bc15_l1_to_bc_l1_map_2900_dst');
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc16', 1, 'bc', 1, 2500, NULL, 'dst'); -- Generates about 1000 (817) DST rows
INSERT INTO casfri50_test.dst_bc_new
SELECT * FROM TT_Translate_bc_dst_test('rawfri', 'bc16_l1_to_bc_l1_map_2500_dst');
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'bc18', 1, 'bc', 1, 2200, NULL, 'dst'); -- Generates about 1000 (1024) DST rows
INSERT INTO casfri50_test.dst_bc_new
SELECT * FROM TT_Translate_bc_dst_test('rawfri', 'bc18_l1_to_bc_l1_map_2200_dst');
------------------------
...
/*
SELECT * 
FROM TT_CheckNumberOfTests('dst', 'bc', TRUE)
