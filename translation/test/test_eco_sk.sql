...
SELECT TT_Prepare('translation', 'sk_utm01_eco', '_sk_utm_eco_test', 'ab_avi01_eco', FALSE);
SELECT TT_Prepare('translation', 'sk_sfv01_eco', '_sk_sfv_eco_test', 'ab_avi01_eco', FALSE);
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'sk02', 'sk_sfv', 1500, NULL, 'eco'); -- Generates about 50 (59) ECO rows
INSERT INTO casfri50_test.eco_sk_new 
SELECT * FROM TT_Translate_sk_sfv_eco_test('rawfri', 'sk02_l1_to_sk_sfv_l1_map_1500_eco');
------------------------
SELECT TT_CreateMappingView('rawfri', 'sk03', 'sk_sfv', 1200, NULL, 'eco'); -- Generates about 50 (52) ECO rows
INSERT INTO casfri50_test.eco_sk_new 
SELECT * FROM TT_Translate_sk_sfv_eco_test('rawfri', 'sk03_l1_to_sk_sfv_l1_map_1200_eco');
------------------------
...
------------------------
SELECT TT_CreateMappingView('rawfri', 'sk07', 'sk_utm', 1800, NULL, 'eco'); -- Generates about 500 (524) ECO rows
INSERT INTO casfri50_test.eco_sk_new 
SELECT * FROM TT_Translate_sk_utm_eco_test('rawfri', 'sk07_l1_to_sk_utm_l1_map_1800_eco');
------------------------
...
------------------------
-- SELECT *
-- FROM TT_CheckNumberOfTests('eco', 'sk', TRUE)
