...
SELECT TT_Prepare('translation', 'nl_nli01_nfl', '_nl_nli01_nfl_test', 'ab_avi01_nfl', FALSE);
SELECT TT_Prepare('translation', 'nl_nli02_nfl', '_nl_nli02_nfl_test', 'ab_avi01_nfl', FALSE);
------------------------
...
/*
SELECT * 
FROM TT_CheckNumberOfTests('nfl', 'nl', TRUE)
