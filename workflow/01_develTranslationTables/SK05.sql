...
SELECT TT_CreateMappingView('rawfri', 'sk05', 'sk_sfv', 200, 'lyr');
SELECT * FROM TT_Translate_sk05_lyr_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200_lyr', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_lyr_devel');

-- LYR2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk05', 2, 'sk_sfv', 1, 200, 'lyr');
SELECT * FROM TT_Translate_sk05_lyr_devel('rawfri', 'sk05_l2_to_sk_sfv_l1_map_200_lyr', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_lyr_devel');

-- LYR3 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk05', 3, 'sk_sfv', 1, 200, 'lyr');
SELECT * FROM TT_Translate_sk05_lyr_devel('rawfri', 'sk05_l3_to_sk_sfv_l1_map_200_lyr', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_lyr_devel');
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 4, 'sk_sfv', 1, 200, 'nfl');
SELECT * FROM TT_Translate_sk05_nfl_devel('rawfri', 'sk05_l4_to_sk_sfv_l1_map_200_nfl', 'ogc_fid'); -- 3 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_nfl_devel');

-- NFL2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk05', 5, 'sk_sfv', 1, 200, 'nfl');
SELECT * FROM TT_Translate_sk05_nfl_devel('rawfri', 'sk05_l5_to_sk_sfv_l1_map_200_nfl', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_lyr_devel');

-- NFL3 ATTRIBUTES - layer 6 can either be nat_non_veg or non_for_anth, not both.
SELECT TT_CreateMappingView('rawfri', 'sk05', 6, 'sk_sfv', 1, 200, 'nfl');
SELECT * FROM TT_Translate_sk05_nfl_devel('rawfri', 'sk05_l6_to_sk_sfv_l1_map_200_nfl', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_lyr_devel');
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 'sk_sfv', 200, 'dst');
SELECT * FROM TT_Translate_sk05_dst_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200_dst', 'ogc_fid'); -- 4 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 'sk_sfv', 200, 'eco');
SELECT * FROM TT_Translate_sk05_eco_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200_eco', 'ogc_fid');
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 'sk_sfv', 200) --, 'geo');
