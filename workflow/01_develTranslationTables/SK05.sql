...
SELECT TT_CreateMappingView('rawfri', 'sk05', 3, 'sk_sfv', 1, 100, 'lyr');
SELECT * FROM TT_Translate_sk05_lyr_devel('rawfri', 'sk05_l3_to_sk_sfv_l1_map_100_lyr', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_lyr_devel');
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 'sk_sfv', 200, 'nfl');
SELECT * FROM TT_Translate_sk05_nfl_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200_nfl', 'ogc_fid'); -- 3 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk05_sfv01_nfl_devel');

SELECT count(*), nvsl, aquatic_class, CONCAT(nvsl,aquatic_class) FROM rawfri.sk05 GROUP BY nvsl, aquatic_class;
