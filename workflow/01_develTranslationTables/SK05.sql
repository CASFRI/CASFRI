------------------------------------------------------------------------------
-- CASFRI - SK05 translation development script for CASFRI v5
...
SELECT * FROM TT_Translate_sk05_cas_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200'); -- 5 s.
...
SELECT * FROM TT_Translate_sk05_lyr_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200'); -- 7 s.

-- LYR2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk05', 2, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk05_lyr_devel('rawfri', 'sk05_l2_to_sk_sfv_l1_map_200'); -- 7 s.

-- LYR3 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk05', 3, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk05_lyr_devel('rawfri', 'sk05_l3_to_sk_sfv_l1_map_200'); -- 7 s.
...
SELECT * FROM TT_Translate_sk05_nfl_devel('rawfri', 'sk05_l4_to_sk_sfv_l1_map_200'); -- 3 s.

-- NFL2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk05', 5, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk05_nfl_devel('rawfri', 'sk05_l5_to_sk_sfv_l1_map_200'); -- 7 s.
...
SELECT * FROM TT_Translate_sk05_nfl_devel('rawfri', 'sk05_l6_to_sk_sfv_l1_map_200'); -- 7 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 1, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk05_dst_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200'); -- 4 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 'sk_sfv', 200);
SELECT * FROM TT_Translate_sk05_eco_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200');
...
SELECT TT_CreateMappingView('rawfri', 'sk05', 'sk_sfv', 200);
SELECT * FROM TT_Translate_sk05_geo_devel('rawfri', 'sk05_l1_to_sk_sfv_l1_map_200'); -- 2 s.
