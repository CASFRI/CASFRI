...
SELECT * FROM TT_Translate_mb07_cas_devel('rawfri', 'mb07_l1_to_mb_fli_l1_map_200', 'ogc_fid');
SELECT * FROM TT_ShowLastLog('translation_devel', 'mb07_fli01_cas_devel');
...
SELECT * FROM TT_Translate_mb07_lyr_devel('rawfri', 'mb07_l1_to_mb_fli_l1_map_200', 'ogc_fid');
SELECT * FROM TT_ShowLastLog('translation_devel', 'mb07_fli01_lyr_devel');

-- LYR2
SELECT TT_CreateMappingView('rawfri', 'mb07', 2, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb07_lyr_devel('rawfri', 'mb07_l2_to_mb_fli_l1_map_200', 'ogc_fid');

--LYR3
SELECT TT_CreateMappingView('rawfri', 'mb07', 3, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb07_lyr_devel('rawfri', 'mb07_l3_to_mb_fli_l1_map_200', 'ogc_fid');

--LYR4
SELECT TT_CreateMappingView('rawfri', 'mb07', 4, 'mb_fli', 1, 2000);
SELECT * FROM TT_Translate_mb07_lyr_devel('rawfri', 'mb07_l4_to_mb_fli_l1_map_2000', 'ogc_fid');

--LYR5
SELECT TT_CreateMappingView('rawfri', 'mb07', 5, 'mb_fli', 1);
SELECT * FROM TT_Translate_mb07_lyr_devel('rawfri', 'mb07_l5_to_mb_fli_l1_map', 'ogc_fid');
...
SELECT TT_CreateMappingView('rawfri', 'mb07', 1, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb07_dst_devel('rawfri', 'mb07_l1_to_mb_fli_l1_map_200', 'ogc_fid'); -- 4 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'mb07_fli01_dst_devel');
...
SELECT * FROM TT_Translate_mb07_nfl_devel('rawfri', 'mb07_l6_to_mb_fli_l1_map_200', 'ogc_fid');
SELECT * FROM TT_ShowLastLog('translation_devel', 'mb07_fli01_nfl_devel');
...
SELECT TT_CreateMappingView('rawfri', 'mb07', 1, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb07_eco_devel('rawfri', 'mb07_l1_to_mb_fli_l1_map_200', 'ogc_fid'); -- 4 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'mb07_fli01_nfl_devel');
...
SELECT TT_CreateMappingView('rawfri', 'mb07', 1, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb07_geo_devel('rawfri', 'mb07_l1_to_mb_fli_l1_map_200', 'ogc_fid'); -- 4 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'mb07_fli01_geo_devel');
