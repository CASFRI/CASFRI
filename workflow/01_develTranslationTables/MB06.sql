------------------------------------------------------------------------------
-- CASFRI - MB06 translation development script for CASFRI v5
...
SELECT TT_CreateMappingView('rawfri', 'mb06', 'mb_fli', 200);
SELECT * FROM TT_Translate_mb06_cas_devel('rawfri', 'mb06_l1_to_mb_fli_l1_map_200');
...
SELECT * FROM TT_Translate_mb06_lyr_devel('rawfri', 'mb06_l1_to_mb_fli_l1_map_200');

-- LYR2
SELECT TT_CreateMappingView('rawfri', 'mb06', 2, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb06_lyr_devel('rawfri', 'mb06_l2_to_mb_fli_l1_map_200');

--LYR3
SELECT TT_CreateMappingView('rawfri', 'mb06', 3, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb06_lyr_devel('rawfri', 'mb06_l3_to_mb_fli_l1_map_200');

--LYR4
SELECT TT_CreateMappingView('rawfri', 'mb06', 4, 'mb_fli', 1, 2000);
SELECT * FROM TT_Translate_mb06_lyr_devel('rawfri', 'mb06_l4_to_mb_fli_l1_map_2000');

--LYR5
SELECT TT_CreateMappingView('rawfri', 'mb06', 5, 'mb_fli', 1);
SELECT * FROM TT_Translate_mb06_lyr_devel('rawfri', 'mb06_l5_to_mb_fli_l1_map');
...
SELECT TT_CreateMappingView('rawfri', 'mb06', 1, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb06_dst_devel('rawfri', 'mb06_l1_to_mb_fli_l1_map_200'); -- 4 s.
...
SELECT TT_CreateMappingView('rawfri', 'mb06', 6, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb06_nfl_devel('rawfri', 'mb06_l6_to_mb_fli_l1_map_200');
...
SELECT TT_CreateMappingView('rawfri', 'mb06', 1, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb06_eco_devel('rawfri', 'mb06_l1_to_mb_fli_l1_map_200'); -- 4 s.
...
SELECT TT_CreateMappingView('rawfri', 'mb06', 1, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb06_geo_devel('rawfri', 'mb06_l1_to_mb_fli_l1_map_200'); -- 4 s.
