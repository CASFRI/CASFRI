...
SELECT * FROM TT_Translate_sk06_lyr_devel('rawfri', 'sk06_l1_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_sfv01_lyr_devel');

-- LYR2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk06', 2, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_lyr_devel('rawfri', 'sk06_l2_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_sfv01_lyr_devel');

-- LYR3 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk06', 3, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_lyr_devel('rawfri', 'sk06_l3_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_sfv01_lyr_devel');
...
SELECT TT_CreateMappingView('rawfri', 'sk06', 1, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_dst_devel('rawfri', 'sk06_l1_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 4 s.
...
SELECT * FROM TT_Translate_sk06_nfl_devel('rawfri', 'sk06_l4_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 3 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_sfv01_nfl_devel');

-- NFL2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk06', 5, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_nfl_devel('rawfri', 'sk06_l5_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_sfv01_nfl_devel');
...
SELECT * FROM TT_Translate_sk06_nfl_devel('rawfri', 'sk06_l6_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_sfv01_nfl_devel');
