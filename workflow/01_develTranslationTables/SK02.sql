...
SELECT TT_CreateMappingView('rawfri', 'sk02', 1, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_lyr_devel('rawfri', 'sk02_l1_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk02_sfv01_lyr_devel');

-- LYR2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk02', 2, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_lyr_devel('rawfri', 'sk02_l2_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk02_sfv01_lyr_devel');

-- LYR3 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk02', 3, 'sk_sfv', 1);
SELECT * FROM TT_Translate_sk02_lyr_devel('rawfri', 'sk02_l3_to_sk_sfv_l1_map', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk02_sfv01_lyr_devel');
...
SELECT * FROM TT_Translate_sk02_nfl_devel('rawfri', 'sk02_l4_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 3 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk02_sfv01_nfl_devel');

-- NFL2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk02', 5, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_nfl_devel('rawfri', 'sk02_l5_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk02_sfv01_lyr_devel');
...
SELECT * FROM TT_Translate_sk02_nfl_devel('rawfri', 'sk02_l6_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk02_sfv01_lyr_devel');
...
SELECT TT_CreateMappingView('rawfri', 'sk02', 1, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_dst_devel('rawfri', 'sk02_l1_to_sk_sfv_l1_map_200', 'ogc_fid'); -- 4 s.
