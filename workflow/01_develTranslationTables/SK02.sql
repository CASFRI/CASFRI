------------------------------------------------------------------------------
-- CASFRI - SK02 translation development script for CASFRI v5
...
SELECT * FROM TT_Translate_sk02_cas_devel('rawfri', 'sk02_l1_to_sk_sfv_l1_map_200'); -- 5 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk02', 1, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_lyr_devel('rawfri', 'sk02_l1_to_sk_sfv_l1_map_200'); -- 7 s.

-- LYR2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk02', 2, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_lyr_devel('rawfri', 'sk02_l2_to_sk_sfv_l1_map_200'); -- 7 s.

-- LYR3 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk02', 3, 'sk_sfv', 1);
SELECT * FROM TT_Translate_sk02_lyr_devel('rawfri', 'sk02_l3_to_sk_sfv_l1_map'); -- 7 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk02', 4, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_nfl_devel('rawfri', 'sk02_l4_to_sk_sfv_l1_map_200'); -- 3 s.

-- NFL2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk02', 5, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_nfl_devel('rawfri', 'sk02_l5_to_sk_sfv_l1_map_200'); -- 7 s.

-- NFL3 ATTRIBUTES - layer 6 can either be nat_non_veg or non_for_anth, not both.
SELECT TT_CreateMappingView('rawfri', 'sk02', 6, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_nfl_devel('rawfri', 'sk02_l6_to_sk_sfv_l1_map_200'); -- 7 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk02', 1, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_dst_devel('rawfri', 'sk02_l1_to_sk_sfv_l1_map_200'); -- 4 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk02', 1, 'sk_sfv', 1, 200);
SELECT * FROM TT_Translate_sk02_eco_devel('rawfri', 'sk02_l1_to_sk_sfv_l1_map_200');
...
SELECT * FROM TT_Translate_sk02_geo_devel('rawfri', 'sk02_l1_to_sk_sfv_l1_map_200'); -- 2 s.
