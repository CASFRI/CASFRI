...
SELECT TT_CreateMappingView('rawfri', 'sk06', 1, 'nt_sfv', 1, 200);
...
SELECT TT_CreateMappingView('rawfri', 'sk06', 1, 'nt_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_lyr_devel('rawfri', 'sk06_l1_to_nt_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_fvi01_lyr_devel');

-- LYR2 ATTRIBUTES
SELECT TT_CreateMappingView('rawfri', 'sk06', 2, 'nt_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_lyr_devel('rawfri', 'sk06_l2_to_nt_sfv_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_fvi01_lyr_devel');
...
SELECT TT_CreateMappingView('rawfri', 'sk06', 1, 'nt_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_dst_devel('rawfri', 'sk06_l1_to_nt_sfv_l1_map_200', 'ogc_fid'); -- 4 s.
...
SELECT TT_CreateMappingView('rawfri', 'sk06', 4, 'nt_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_nfl_devel('rawfri', 'sk06_l4_to_nt_sfv_l1_map_200', 'ogc_fid'); -- 3 s.
...
FROM TT_Translate_sk02_nfl_devel('rawfri', 'sk02_l1_to_nt_sfv_l1_map_200') a, rawfri.sk02_l1_to_nt_sfv_l1_map_200_nfl b
...
SELECT TT_CreateMappingView('rawfri', 'sk06', 1, 'nt_sfv', 1, 200);
SELECT * FROM TT_Translate_sk06_eco_devel('rawfri', 'sk06_l1_to_nt_sfv_l1_map_200', 'ogc_fid');
