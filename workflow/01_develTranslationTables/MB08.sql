------------------------------------------------------------------------------
-- CASFRI - MB08 translation development script for CASFRI v5
...
SELECT * FROM TT_Translate_mb08_lyr_devel('rawfri', 'mb08_l2_to_mb_fli_l1_map_200');
...
DROP TABLE IF EXISTS translation_devel.mb08_fli01_nfl_devel;
...
SELECT TT_CreateMappingView('rawfri', 'mb08', 6, 'mb_fli', 1, 200);
SELECT * FROM TT_Translate_mb08_nfl_devel('rawfri', 'mb08_l6_to_mb_fli_l1_map_200');
...
DROP TABLE IF EXISTS translation_devel.mb08_fli01_geo_devel;
CREATE TABLE translation_devel.mb08_fli01_geo_devel AS
...
SELECT b.src_filename, b.inventory_id, b.orig_stand_id, b.ogc_fid, a.cas_id, 
       b.cc, a.crown_closure_lower, a.crown_closure_upper, 
       b.ht, a.height_upper, a.height_lower, 
       b.species_1, a.species_1,
       b.species_per_1, a.species_per_1
