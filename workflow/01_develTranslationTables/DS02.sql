------------------------------------------------------------------------------
-- CASFRI - ds02 translation development script for CASFRI v5
...
SELECT TT_Prepare('translation_devel', 'ds_cfs01_cas_devel', '_ds02_cas_devel');
SELECT TT_CreateMappingView('rawfri', 'ds02', 'ds', 200);
SELECT * FROM TT_Translate_ds02_cas_devel('rawfri', 'ds02_l1_to_ds_l1_map_200');

-- Display original values and translated values side-by-side to compare and debug the translation table
SELECT b.inventory_id, b.src_filename, b.map_sheet_id, b.orig_stand_id, b.ogc_fid, a.cas_id,
       b.stand_photo_year, a.stand_photo_year
FROM TT_Translate_ds02_cas_devel('rawfri', 'ds02_l1_to_ds_l1_map_200') a, 
     rawfri.ds02_l1_to_ds_l1_map_200 b
...
SELECT TT_Prepare('translation_devel', 'ds_cfs01_dst_devel', '_ds02_dst_devel');
SELECT TT_CreateMappingView('rawfri', 'ds02', 'ds', 200);
SELECT * FROM TT_Translate_ds02_dst_devel('rawfri', 'ds02_l1_to_ds_l1_map_200'); -- 4 s.

-- Display original values and translated values side-by-side to compare and debug the translation table
SELECT b.inventory_id, b.src_filename, b.map_sheet_id, b.orig_stand_id, b.ogc_fid, a.cas_id,
       b.stand_photo_year, a.dist_year_1
FROM TT_Translate_ds02_dst_devel('rawfri', 'ds02_l1_to_ds_l1_map_200') a, 
     rawfri.ds02_l1_to_ds_l1_map_200 b
WHERE b.ogc_fid::int = trim(leading 'x' from right(a.cas_id, 7))::int;
...
SELECT TT_Prepare('translation_devel', 'ds_cfs01_geo_devel', '_ds02_geo_devel');
SELECT TT_CreateMappingView('rawfri', 'ds02', 'ds', 200);
SELECT * FROM TT_Translate_ds02_geo_devel('rawfri', 'ds02_l1_to_ds_l1_map_200'); -- 4 s.
