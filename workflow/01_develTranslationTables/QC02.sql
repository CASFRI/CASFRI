...
SELECT * FROM TT_Translate_qc02_lyr_devel('rawfri', 'qc02_l2_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'qc02_ini03_lyr_devel', 'qc02_l2_to_qc_ini03_l1_map_200');

SELECT TT_CreateMappingView('rawfri', 'qc02', 3, 'qc_ini03', 1, 200);
SELECT * FROM TT_Translate_qc02_nfl_devel('rawfri', 'qc02_l3_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'qc02_ini03_nfl_devel', 'qc02_l3_to_qc_ini03_l1_map_200');

SELECT * FROM TT_Translate_qc02_geo_devel('rawfri', 'qc02_l1_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'qc02_ini03_geo_devel', 'qc02_l1_to_qc_ini03_l1_map_200');
