...
SELECT * FROM translation.qc_ini03_lyr
WHERE rule_id::int <15 AND rule_id::int <19
;
-- display
...
SELECT * FROM TT_Translate_qc03_lyr_devel('rawfri', 'qc03_l2_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'qc03_ini03_lyr_devel');

--SELECT * FROM TT_Translate_qc03_lyr_devel('rawfri', 'qc03_l2_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
--SELECT * FROM TT_ShowLastLog('translation_devel', 'qc03_ini03_lyr_devel');

SELECT * FROM TT_Translate_qc03_nfl_devel('rawfri', 'qc03_l1_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'qc03_ini03_nfl_devel');

--SELECT * FROM TT_Translate_qc03_nfl_devel('rawfri', 'qc03_l2_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
--SELECT * FROM TT_ShowLastLog('translation_devel', 'qc03_ini03_nfl_devel');

SELECT * FROM TT_Translate_qc03_geo_devel('rawfri', 'qc03_l2_to_qc_ini03_l1_map_200', 'ogc_fid'); -- 7 s.
