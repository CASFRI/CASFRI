...
SELECT * FROM TT_ShowLastLog('translation', 'pe_pei01_cas');
...
SELECT * FROM TT_ShowLastLog('translation', 'pe_pei01_dst');
...
SELECT * FROM TT_ShowLastLog('translation', 'pe_pei01_eco');
...
SELECT * FROM TT_ShowLastLog('translation', 'pe_pei01_lyr');
...
SELECT * FROM TT_ShowLastLog('translation', 'pe_pei01_nfl');
...
SELECT * FROM TT_ShowLastLog('translation', 'pe_pei01_geo');
--------------------------------------------------------------------------
-- Check
