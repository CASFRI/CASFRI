------------------------------------------------------------------------------
-- CASFRI - MB04 translation script for CASFRI v5
...
-- Add translated NFL
SELECT TT_CreateMappingView('rawfri', 'mb04', 6, 'mb_fli', 1);

INSERT INTO casfri50.nfl_all -- 
SELECT * FROM TT_Translate_mb04_nfl('rawfri', 'mb04_l6_to_mb_fli_l1_map');
