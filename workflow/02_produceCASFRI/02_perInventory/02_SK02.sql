------------------------------------------------------------------------------
-- CASFRI - SK02 translation script for CASFRI v5
...
SELECT * FROM TT_Translate_sk02_cas('rawfri', 'sk02_l1_to_sk_sfv_l1_map');
...
SELECT * FROM TT_Translate_sk02_dst('rawfri', 'sk02_l1_to_sk_sfv_l1_map');
...
SELECT * FROM TT_Translate_sk02_eco('rawfri', 'sk02_l1_to_sk_sfv_l1_map');
...
SELECT * FROM TT_Translate_sk02_lyr('rawfri', 'sk02_l1_to_sk_sfv_l1_map');
...
SELECT * FROM TT_Translate_sk02_lyr('rawfri', 'sk02_l2_to_sk_sfv_l1_map');
...
SELECT * FROM TT_Translate_sk02_lyr('rawfri', 'sk02_l3_to_sk_sfv_l1_map');
...
SELECT * FROM TT_Translate_sk02_nfl('rawfri', 'sk02_l4_to_sk_sfv_l1_map'); 
...
SELECT * FROM TT_Translate_sk02_nfl('rawfri', 'sk02_l5_to_sk_sfv_l1_map'); 
...
SELECT * FROM TT_Translate_sk02_nfl('rawfri', 'sk02_l6_to_sk_sfv_l1_map'); 
...
SELECT * FROM TT_Translate_sk02_geo('rawfri', 'sk02_l1_to_sk_sfv_l1_map');
