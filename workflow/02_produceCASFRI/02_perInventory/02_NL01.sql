------------------------------------------------------------------------------
-- CASFRI - NL01 translation script for CASFRI v5
...
SELECT TT_CreateMappingView('rawfri', 'nl01', 'nl_nli1');
...
SELECT * FROM TT_Translate_nl01_cas('rawfri', 'nl01_l1_to_nl_nli1_l1_map');
COMMIT;
...
SELECT TT_CreateMappingView('rawfri', 'nl01', 1, 'nl_nli1', 1);
...
SELECT * FROM TT_Translate_nl01_dst('rawfri', 'nl01_l1_to_nl_nli1_l1_map');
COMMIT;
...
SELECT * FROM TT_Translate_nl01_eco('rawfri', 'nl01_l1_to_nl_nli1_l1_map');
COMMIT;
...
SELECT * FROM TT_Translate_nl01_lyr('rawfri', 'nl01_l1_to_nl_nli1_l1_map');
COMMIT;
...
SELECT TT_CreateMappingView('rawfri', 'nl01', 2, 'nl_nli1', 1);
...
SELECT * FROM TT_Translate_nl01_nfl('rawfri', 'nl01_l2_to_nl_nli1_l1_map');
COMMIT;
...
SELECT * FROM TT_Translate_nl01_geo('rawfri', 'nl01_l1_to_nl_nli1_l1_map');
COMMIT;
