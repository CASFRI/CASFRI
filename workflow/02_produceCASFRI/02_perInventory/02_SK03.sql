...
SELECT * FROM TT_Translate_sk_dst('rawfri', 'sk03_l1_to_sk_sfv_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_sk_eco('rawfri', 'sk03_l1_to_sk_sfv_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_sk_lyr('rawfri', 'sk03_l1_to_sk_sfv_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_sk_lyr('rawfri', 'sk03_l2_to_sk_sfv_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_sk_lyr('rawfri', 'sk03_l3_to_sk_sfv_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_sk_nfl('rawfri', 'sk03_l4_to_sk_sfv_l1_map', 'ogc_fid'); 
...
SELECT * FROM TT_Translate_sk_nfl('rawfri', 'sk03_l5_to_sk_sfv_l1_map', 'ogc_fid'); 
...
SELECT * FROM TT_Translate_sk_nfl('rawfri', 'sk03_l6_to_sk_sfv_l1_map', 'ogc_fid'); 
...
SELECT * FROM TT_Translate_sk_geo('rawfri', 'sk03_l1_to_sk_sfv_l1_map', 'ogc_fid');
