...
SELECT * FROM TT_Translate_ab_dst('rawfri', 'ab06_l1_to_ab_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_ab_dst('rawfri', 'ab16_l1_to_ab_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_bc_dst('rawfri', 'bc08_l1_to_bc_l1_map', 'ogc_fid');
...
INSERT INTO casfri50.dst_all -- 7h3m
SELECT * FROM TT_Translate_bc_dst('rawfri', 'bc10_l1_to_bc_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_nt_dst('rawfri', 'nt01_l1_to_nt_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_on_dst('rawfri', 'on02_l1_to_on_l1_map', 'ogc_fid');
