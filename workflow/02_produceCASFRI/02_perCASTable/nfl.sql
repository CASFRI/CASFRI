...
SELECT * FROM TT_Translate_ab_nfl('rawfri', 'ab06_l1_to_ab_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_ab_nfl('rawfri', 'ab06_l2_to_ab_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_ab_nfl('rawfri', 'ab16_l1_to_ab_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_ab_nfl('rawfri', 'ab16_l2_to_ab_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_nb_nfl('rawfri', 'nb01_l1_to_nb_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_bc_nfl('rawfri', 'bc08_l1_to_bc_l1_map', 'ogc_fid');
...
SELECT * FROM TT_Translate_bc_nfl('rawfri', 'bc10_l1_to_bc_l1_map', 'ogc_fid');
...
INSERT INTO casfri50.nfl_all -- 
SELECT * FROM TT_Translate_nt_nfl('rawfri', 'nt01_l1_to_nt_l1_map', 'ogc_fid');
