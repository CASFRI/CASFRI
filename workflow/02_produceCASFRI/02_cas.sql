...
SELECT TT_Prepare('translation', 'nb01_nbi01_cas', '_nb_cas',   'ab06_avi01_cas'); -- used for both NB01 and NB02
SELECT TT_Prepare('translation', 'bc08_vri01_cas', '_bc08_cas', 'ab06_avi01_cas');
SELECT TT_Prepare('translation', 'nt01_fvi01_cas', '_nt_cas',   'ab06_avi01_cas'); -- used for both NT01 and NT02
------------------------
