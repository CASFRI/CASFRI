...
-------------------------------------------------------
SELECT * FROM TT_TestCount(1, ARRAY[35305480, 11045284, 2991378, 28179225, 10456653])
-------------------------------------------------------
...
-------------------------------------------------------
UNION ALL
SELECT * FROM TT_TestCount(2, ARRAY[61633, 6426, 3776, 72787, 19001], 'AB03')
UNION ALL
SELECT * FROM TT_TestCount(3, ARRAY[11484, 1875, 1174, 14179, 3515], 'AB06')
UNION ALL
SELECT * FROM TT_TestCount(4, ARRAY[23268, 1418, 1516, 33811, 4770], 'AB07')
UNION ALL
SELECT * FROM TT_TestCount(5, ARRAY[34474, 6202, 1022, 44227, 7729], 'AB08')
UNION ALL
SELECT * FROM TT_TestCount(6, ARRAY[194696, 30757, 25183, 225160, 60555], 'AB10')
UNION ALL
SELECT * FROM TT_TestCount(7, ARRAY[118624, 16740, 7441, 112854, 23805], 'AB11')
UNION ALL
SELECT * FROM TT_TestCount(8, ARRAY[120476, 8873, 5528, 149674, 26858], 'AB16')
UNION ALL
SELECT * FROM TT_TestCount(9, ARRAY[527038, 24122, 47372, 529256, 231921], 'AB25')
UNION ALL
SELECT * FROM TT_TestCount(10, ARRAY[620944, 47445, 53682, 651779, 260247], 'AB29')
UNION ALL
SELECT * FROM TT_TestCount(11, ARRAY[4555, 4555, 0, 0, 0], 'AB30')
UNION ALL
SELECT * FROM TT_TestCount(12, ARRAY[4677411, 1142604, 66837, 4272025, 1998885], 'BC08')
UNION ALL
SELECT * FROM TT_TestCount(13, ARRAY[5151772, 1421223, 70989, 4744673, 2276213], 'BC10')
UNION ALL
SELECT * FROM TT_TestCount(14, ARRAY[1644808, 0, 171269, 854163, 340124], 'MB05')
UNION ALL
SELECT * FROM TT_TestCount(15, ARRAY[163064, 42802, 0, 213982, 9826], 'MB06')
UNION ALL
SELECT * FROM TT_TestCount(16, ARRAY[927177, 252564, 72978, 932271, 78227], 'NB01')
UNION ALL
SELECT * FROM TT_TestCount(17, ARRAY[1123893, 333114, 107264, 1053554, 139930], 'NB02')
UNION ALL
SELECT * FROM TT_TestCount(18, ARRAY[1863664, 91851, 238785, 867045, 664096], 'NL01')
UNION ALL
SELECT * FROM TT_TestCount(19, ARRAY[995886, 69446, 122782, 972710, 212453], 'NS03')
UNION ALL
SELECT * FROM TT_TestCount(20, ARRAY[281388, 77270, 49989, 245832, 65299], 'NT01')
UNION ALL
SELECT * FROM TT_TestCount(21, ARRAY[320944, 129867, 69141, 349923, 129291], 'NT02')
UNION ALL
SELECT * FROM TT_TestCount(22, ARRAY[3629072, 1970285, 0, 2240815, 1318495], 'ON02')
UNION ALL
SELECT * FROM TT_TestCount(23, ARRAY[8094, 0, 1767, 7319, 3593], 'PC01')
UNION ALL
SELECT * FROM TT_TestCount(24, ARRAY[1053, 505, 1947, 1760, 1614], 'PC02')
UNION ALL
SELECT * FROM TT_TestCount(25, ARRAY[107220, 29517, 1488, 81073, 22223], 'PE01')
UNION ALL
SELECT * FROM TT_TestCount(26, ARRAY[401188, 81902, 50600, 160597, 197876], 'QC03')
UNION ALL
SELECT * FROM TT_TestCount(27, ARRAY[2487519, 1444257, 243352, 1720580, 328940], 'QC04')
UNION ALL
SELECT * FROM TT_TestCount(28, ARRAY[6768074, 3519874, 879228, 5133315, 1016269], 'QC05')
UNION ALL
SELECT * FROM TT_TestCount(29, ARRAY[1501667, 64052, 474842, 860394, 340357], 'SK01')
UNION ALL
SELECT * FROM TT_TestCount(30, ARRAY[27312, 9020, 953, 28983, 17529], 'SK02')
UNION ALL
SELECT * FROM TT_TestCount(31, ARRAY[8964, 236, 407, 10767, 6845], 'SK03')
UNION ALL
SELECT * FROM TT_TestCount(32, ARRAY[633522, 93980, 106590, 708553, 311133], 'SK04')
UNION ALL
SELECT * FROM TT_TestCount(33, ARRAY[421977, 58248, 85120, 483663, 184184], 'SK05')
UNION ALL
SELECT * FROM TT_TestCount(34, ARRAY[211482, 45081, 28356, 296399, 78506], 'SK06')
UNION ALL
SELECT * FROM TT_TestCount(35, ARRAY[231137, 19173, 0, 105102, 76344], 'YT02')
-------------------------------------------------------
UNION ALL
