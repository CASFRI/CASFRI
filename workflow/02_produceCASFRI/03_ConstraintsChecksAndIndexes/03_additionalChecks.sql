...
UNION ALL
SELECT * FROM TT_TestCount(17, ARRAY[1644808, 0, 171269, 854163, 340124], 'MB05')
UNION ALL
SELECT * FROM TT_TestCount(18, ARRAY[163064, 42802, 0, 213982, 9826], 'MB06')
UNION ALL
...
UNION ALL
SELECT * FROM TT_TestCount(21, ARRAY[1123893, 333114, 107264, 1053554, 139930], 'NB02')
UNION ALL
SELECT * FROM TT_TestCount(22, ARRAY[1863664, 91851, 238785, 867045, 664096], 'NL01')
UNION ALL
SELECT * FROM TT_TestCount(23, ARRAY[1127926, 0, 0, 0, 0], 'NS01')
UNION ALL
SELECT * FROM TT_TestCount(24, ARRAY[1090671, 0, 0, 0, 0], 'NS02')
UNION ALL
SELECT * FROM TT_TestCount(25, ARRAY[995886, 69446, 122782, 972710, 212453], 'NS03')
UNION ALL
SELECT * FROM TT_TestCount(26, ARRAY[281388, 77270, 49989, 245832, 65299], 'NT01')
UNION ALL
...
UNION ALL
SELECT * FROM TT_TestCount(29, ARRAY[8094, 0, 1767, 7319, 3593], 'PC01')
UNION ALL
SELECT * FROM TT_TestCount(30, ARRAY[1053, 505, 1947, 1760, 1614], 'PC02')
UNION ALL
SELECT * FROM TT_TestCount(31, ARRAY[107220, 29517, 1488, 81073, 22223], 'PE01')
UNION ALL
SELECT * FROM TT_TestCount(32, ARRAY[401188, 81902, 50600, 160597, 197876], 'QC03')
UNION ALL
SELECT * FROM TT_TestCount(33, ARRAY[2487519, 1444257, 243352, 1720580, 328940], 'QC04')
UNION ALL
SELECT * FROM TT_TestCount(34, ARRAY[6768074, 3519874, 879228, 5133315, 1016269], 'QC05')
UNION ALL
SELECT * FROM TT_TestCount(35, ARRAY[1501667, 64052, 474842, 860394, 340357], 'SK01')
UNION ALL
SELECT * FROM TT_TestCount(36, ARRAY[27312, 9020, 953, 28983, 17529], 'SK02')
UNION ALL
SELECT * FROM TT_TestCount(37, ARRAY[8964, 236, 407, 10767, 6845], 'SK03')
UNION ALL
SELECT * FROM TT_TestCount(38, ARRAY[633522, 93980, 106590, 708553, 311133], 'SK04')
UNION ALL
SELECT * FROM TT_TestCount(39, ARRAY[421977, 58248, 85120, 483663, 184184], 'SK05')
UNION ALL
SELECT * FROM TT_TestCount(40, ARRAY[211482, 45081, 28356, 296399, 78506], 'SK06')
UNION ALL
