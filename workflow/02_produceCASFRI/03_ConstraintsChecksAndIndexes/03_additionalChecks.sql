...
-------------------------------------------------------
UNION ALL
SELECT * FROM TT_TestCount(2, ARRAY[11484, 1875, 0, 14179, 4178], 'AB06')
UNION ALL
SELECT * FROM TT_TestCount(3, ARRAY[120476, 8873, 0, 149674, 20295], 'AB16')
UNION ALL
SELECT * FROM TT_TestCount(4, ARRAY[4677411, 1142604, 0, 4113383, 4923735], 'BC08')
UNION ALL
SELECT * FROM TT_TestCount(5, ARRAY[5151772, 1421223, 0, 4744673, 5622294], 'BC10')
UNION ALL
SELECT * FROM TT_TestCount(6, ARRAY[927177, 252564, 72978, 932271, 78227], 'NB01')
UNION ALL
SELECT * FROM TT_TestCount(7, ARRAY[1123893, 333114, 111135, 1053554, 141747], 'NB02')
UNION ALL
...
UNION ALL
SELECT * FROM TT_TestCount(11, ARRAY[1501667, 64052, 0, 1692982, 340357], 'SK01')
UNION ALL
