...
(WITH expected AS (
  ...
  SELECT 'NS01' inv, 1127924 cnt UNION ALL 
  SELECT 'NS02' inv, 1090669 cnt UNION ALL 
...
(WITH expected AS (
  ...
  SELECT 'AB07' inv, 3603 cnt UNION ALL 
  ...
  SELECT 'ON01' inv, 1070292 cnt UNION ALL 
  ...
  SELECT 'SK02' inv, 17386 cnt UNION ALL 
  SELECT 'SK03' inv, 6799 cnt UNION ALL 
  SELECT 'SK04' inv, 311133 cnt UNION ALL 
  SELECT 'SK05' inv, 184184 cnt UNION ALL 
  SELECT 'SK06' inv, 78061 cnt UNION ALL 
