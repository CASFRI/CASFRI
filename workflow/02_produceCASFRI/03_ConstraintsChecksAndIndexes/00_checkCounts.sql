...
(WITH expected AS (
  ...
  SELECT 'BC14' inv, 5376926 cnt UNION ALL 
  SELECT 'BC15' inv, 5398030 cnt UNION ALL 
  SELECT 'BC16' inv, 5901370 cnt UNION ALL 
  SELECT 'BC17' inv, 4972179 cnt UNION ALL 
  SELECT 'BC18' inv, 6250929 cnt UNION ALL 
  ...
  SELECT 'NB03' inv, 1511418 cnt UNION ALL 
  SELECT 'NB06' inv, 1672622 cnt UNION ALL 
  ...
  SELECT 'NS04' inv, 1004111 cnt UNION ALL 
  SELECT 'NT01' inv, 281388 cnt UNION ALL 
  SELECT 'NT03' inv, 320526 cnt UNION ALL 
  SELECT 'NT04' inv, 53360 cnt UNION ALL 
  ...
  SELECT 'QC08' inv, 404179 cnt UNION ALL 
  SELECT 'QC09' inv, 563695 cnt UNION ALL 
  SELECT 'QC10' inv, 8897958 cnt UNION ALL 
...
(WITH expected AS (
  ...
  SELECT 'BC14' inv, 1705153 cnt UNION ALL 
  SELECT 'BC15' inv, 1751563 cnt UNION ALL 
  SELECT 'BC16' inv, 2386990 cnt UNION ALL 
  SELECT 'BC17' inv, 1352148 cnt UNION ALL 
  SELECT 'BC18' inv, 2667707 cnt UNION ALL 
  SELECT 'DS01' inv, 59539 cnt UNION ALL 
  SELECT 'DS02' inv, 15358919 cnt UNION ALL 
  SELECT 'DS03' inv, 27593270 cnt UNION ALL 
  ...
  SELECT 'NB03' inv, 501021 cnt UNION ALL 
  SELECT 'NB06' inv, 613413 cnt UNION ALL 
  ...
  SELECT 'NS04' inv, 63633 cnt UNION ALL 
  SELECT 'NT01' inv, 77270 cnt UNION ALL 
  SELECT 'NT03' inv, 87975 cnt UNION ALL 
  SELECT 'NT04' inv, 19360 cnt UNION ALL 
  ...
  SELECT 'QC08' inv, 82957 cnt UNION ALL 
  SELECT 'QC09' inv, 346636 cnt UNION ALL 
  SELECT 'QC10' inv, 4705293 cnt UNION ALL 
...
(WITH expected AS (
  ...
  SELECT 'BC14' inv, 53554 cnt UNION ALL 
  SELECT 'BC15' inv, 51539 cnt UNION ALL 
  SELECT 'BC16' inv, 68910 cnt UNION ALL 
  SELECT 'BC17' inv, 51857 cnt UNION ALL 
  SELECT 'BC18' inv, 84006 cnt UNION ALL 
  ...
  SELECT 'NB03' inv, 119622 cnt UNION ALL 
  SELECT 'NB06' inv, 138677 cnt UNION ALL 
  ...
  SELECT 'NS04' inv, 119066 cnt UNION ALL 
  SELECT 'NT01' inv, 49989 cnt UNION ALL 
  SELECT 'NT03' inv, 69141 cnt UNION ALL 
  SELECT 'NT04' inv, 34370 cnt UNION ALL 
  ...
  SELECT 'QC08' inv, 49754 cnt UNION ALL 
  SELECT 'QC09' inv, 70638 cnt UNION ALL 
  SELECT 'QC10' inv, 1071502 cnt UNION ALL 
...
(WITH expected AS (
  ...
  SELECT 'BC14' inv, 5517043 cnt UNION ALL 
  SELECT 'BC15' inv, 5578663 cnt UNION ALL 
  SELECT 'BC16' inv, 6096999 cnt UNION ALL 
  SELECT 'BC17' inv, 5065969 cnt UNION ALL 
  SELECT 'BC18' inv, 6457169 cnt UNION ALL 
  SELECT 'DS01' inv, 0 cnt UNION ALL 
  SELECT 'DS02' inv, 0 cnt UNION ALL 
  SELECT 'DS03' inv, 0 cnt UNION ALL 
  SELECT 'DS04' inv, 0 cnt UNION ALL
  ...
  SELECT 'NB03' inv, 1389068 cnt UNION ALL
  SELECT 'NB06' inv, 1564443 cnt UNION ALL
  ...
  SELECT 'NS04' inv, 1072827 cnt UNION ALL
  SELECT 'NT01' inv, 245837 cnt UNION ALL
  SELECT 'NT03' inv, 349965 cnt UNION ALL
  SELECT 'NT04' inv, 16966 cnt UNION ALL 
  ...
  SELECT 'PE03' inv, 99030 cnt UNION ALL
  ...
  SELECT 'QC08' inv, 171525 cnt UNION ALL 
  SELECT 'QC09' inv, 299234 cnt UNION ALL 
  SELECT 'QC10' inv, 6859557 cnt UNION ALL 
...
(WITH expected AS (
  ...
  SELECT 'BC14' inv, 1958096 cnt UNION ALL 
  SELECT 'BC15' inv, 1922790 cnt UNION ALL 
  SELECT 'BC16' inv, 2225459 cnt UNION ALL 
  SELECT 'BC17' inv, 1659560 cnt UNION ALL 
  SELECT 'BC18' inv, 2382320 cnt UNION ALL 
  SELECT 'DS01' inv, 0 cnt UNION ALL 
  SELECT 'DS02' inv, 0 cnt UNION ALL 
  SELECT 'DS03' inv, 0 cnt UNION ALL 
  ...
  SELECT 'NB03' inv, 186831 cnt UNION ALL 
  SELECT 'NB06' inv, 207437 cnt UNION ALL 
  ...
  SELECT 'NS04' inv, 190177 cnt UNION ALL 
  SELECT 'NT01' inv, 65299 cnt UNION ALL 
  SELECT 'NT03' inv, 129291 cnt UNION ALL 
  SELECT 'NT04' inv, 36806 cnt UNION ALL 
  ...
  SELECT 'QC08' inv, 196892 cnt UNION ALL 
  SELECT 'QC09' inv, 86223 cnt UNION ALL 
  SELECT 'QC10' inv, 1246669 cnt UNION ALL 
