...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_nb1_gridded_history.csv" -nln "casfri50_history_test.sampling_area_nb1_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_nb2_gridded_history.csv" -nln "casfri50_history_test.sampling_area_nb2_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_nt1_gridded_history.csv" -nln "casfri50_history_test.sampling_area_nt1_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_nt2_gridded_history.csv" -nln "casfri50_history_test.sampling_area_nt2_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_bc1_gridded_history.csv" -nln "casfri50_history_test.sampling_area_bc1_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_bc2_gridded_history.csv" -nln "casfri50_history_test.sampling_area_bc2_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_sk1_gridded_history.csv" -nln "casfri50_history_test.sampling_area_sk1_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_sk2_gridded_history.csv" -nln "casfri50_history_test.sampling_area_sk2_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_sk3_gridded_history.csv" -nln "casfri50_history_test.sampling_area_sk3_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
...
"$gdalFolder/ogr2ogr" -f "PostgreSQL" "$pg_connection_string" "./testtables/sampling_area_sk4_gridded_history.csv" -nln "casfri50_history_test.sampling_area_sk4_gridded_history" $overwrite_tab -lco COLUMN_TYPES="$coltypes"_gridded
