...
DROP TABLE IF EXISTS casfri50_history_test.sampling_areas CASCADE;
CREATE TABLE casfri50_history_test.sampling_areas AS
SELECT 'NB1' id, 'NB01 (2009) and NB02 (2009)' description, ST_MakeEnvelope(2200000, 1200000, 2210000, 1210000, 102001) geometry
UNION ALL
SELECT 'NB2' id, 'NB01 (2004) and NB02 (2014)', ST_MakeEnvelope(2200000, 1100000, 2210000, 1110000, 102001) geometry
UNION ALL
SELECT 'NT1' id, 'NT01 (-9999) and NT03 (1970)', ST_MakeEnvelope(-1400000, 2600000, -1390000, 2610000, 102001) geometry
UNION ALL
SELECT 'NT2' id, 'NT01 (2003-2006) and NT03 (2003-2006)', ST_MakeEnvelope(-1200000, 2600000, -1190000, 2610000, 102001) geometry
UNION ALL
SELECT 'BC1' id, 'BC08 (2005-2015) and BC10 (2018)', ST_MakeEnvelope(-1940000, 1980000, -1930000, 1990000, 102001) geometry
UNION ALL
SELECT 'BC2' id, 'BC08 (1965-2015) and BC10 (2012-2017)', ST_MakeEnvelope(-1810000, 1800000, -1800000, 1810000, 102001) geometry
UNION ALL
SELECT 'SK1' id, 'SK01 (1971-2001) and SK02 (2004-2012)', ST_MakeEnvelope(-580000, 1500000, -570000, 1510000, 102001) geometry
UNION ALL
SELECT 'SK2' id, 'SK01 (1971-2001), SK04 (1998-2005) and SK05 (1998-2004)', ST_MakeEnvelope(-610000, 1570000, -600000, 1580000, 102001) geometry
UNION ALL
SELECT 'SK3' id, 'SK01 (1971-2001) and SK03 (2008-2008)', ST_MakeEnvelope(-802000, 1665000, -792000, 1675000, 102001) geometry
UNION ALL
SELECT 'SK4' id, 'SK01 (1971-2001) and SK06 (1994-2005)', ST_MakeEnvelope(-840000, 1800000, -830000, 1810000, 102001) geometry
;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nb1 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nb1_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nb1_history_with_validity_new CASCADE;
...
-- 60 57s
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nb1_history_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nb2 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nb2_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nb2_history_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nt1 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nt1_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nt1_history_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nt2 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nt2_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_nt2_history_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_bc1 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_bc1_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_bc1_history_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_bc2 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_bc2_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_bc2_history_polyperpoly_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk1 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk1_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk1_history_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk2 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk2_history_new CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk3 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk3_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk3_history_polyperpoly_new2 CASCADE;
...
--------------------------------------------------------------------------------------
-- Intersect with CASFRI
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk4 CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk4_history_new CASCADE;
...
DROP TABLE IF EXISTS casfri50_history_test.sampling_area_sk4_history_polyperpoly_new2 CASCADE;
