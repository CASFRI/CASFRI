...
SELECT '35.1'::text number,
       ...
       'Count of 3, non_for_veg 1'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'V', 'BL', '', '', '', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.2'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, non_for_veg 2'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'I', '', 'BL', '', '', '3', 'FALSE') = 3 passed
---------------------------------------------------------
  UNION ALL
SELECT '35.3'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, non_for_veg 3'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'F', '', '', 'OR', '', '3', 'FALSE') = 3 passed
---------------------------------------------------------
  UNION ALL
SELECT '35.4'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, non_for_veg 4'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'F', '', 'ST', '', '', '3', 'FALSE') = 3 passed
---------------------------------------------------------
  UNION ALL
SELECT '35.5'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'non_for_veg fail'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'V', '', '', '', '', '3', 'FALSE') = 2 passed
---------------------------------------------------------
UNION ALL
SELECT '35.6'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, nat_non_veg 1'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'V', '', '', '', 'MU', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.7'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, nat_non_veg 2'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'V', 'LL', 'XX', 'XX', 'XX', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.8'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, nat_non_veg 3'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'I', 'XX', 'SI', 'XX', 'XX', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.9'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, nat_non_veg 4'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'F', 'LL', 'XX', 'ICE', '', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.10'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, nat_non_veg 5'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'F', NULL::text, 'RO', NULL::text, NULL::text, '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.11'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'nat_non_veg fail'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'V', 'XX', 'XX', 'XX', 'XX', '3', 'FALSE') = 2 passed
---------------------------------------------------------
UNION ALL
SELECT '35.12'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, non_for_anth 1'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'V', '', '', '', 'AP', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.13'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, non_for_anth 2'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'V', 'AP', 'XX', 'XX', 'XX', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.14'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 3, non_for_anth 3'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{''val'',''val''}', 'F', 'XX', 'XX', 'C', 'XX', '3', 'FALSE') = 3 passed
---------------------------------------------------------
UNION ALL
SELECT '35.15'::text number,
       'TT_vri01_countOfNotNull'::text function_tested,
       'Count of 1'::text description,
       TT_vri01_countOfNotNull('{''val'',''val''}', '{'''',''''}', '', 'XX', 'XX', 'C', 'XX', '3', 'FALSE') = 1 passed
---------------------------------------------------------
UNION ALL
