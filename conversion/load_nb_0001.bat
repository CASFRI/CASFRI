...
::The format of the source dataset is four shapefiles named Forest.shp, Non Forest.shp, Waterbody.shp, and Watercourse.shp
::These four files need to be combined into a single PostgreSQL table
::This can be done using the -append argument and the -addfields argument. Note that -update also needed in order to append in PostgreSQL.
...
::Load the rest of the columns from Waterbaody
ogr2ogr ^
