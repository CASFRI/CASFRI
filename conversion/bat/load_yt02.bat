...
SET inventoryID=YT02
SET srcFileName=YTVegInventory
SET srcFullPath="%friDir%/YT/%inventoryID%/data/inventory/YukonVegInventory.gdb"

SET fullTargetTableName=%targetFRISchema%.yt02
