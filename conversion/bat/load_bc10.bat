...
SET query1=SELECT MAP_ID, POLYGON_ID, OPENING_IND, OPENING_SOURCE, OPENING_NUMBER, ^
...
SET query4=ALTER TABLE rawfri.bc10_layer_1 DROP COLUMN IF EXISTS ogc_fid; ^
...
"%gdalFolder%\ogrinfo" %pg_connection_string% -sql "%query4%"
