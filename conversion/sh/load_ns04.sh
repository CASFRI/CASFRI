...
# The combination of FOREST_, FOREST_ID, MAPSHEET and SRC_FILENAME is a unique identifier 
# across all counties prior to 2007. All four are needed to create the unique id.
# After 2007 the field ID_EFOREST provides a unique identifier across the province
