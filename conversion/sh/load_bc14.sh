...
# This script loads the British Columbia VRI forest inventory (BC14) into PostgreSQL
...
srcFullPath_L1="$friDir/BC/$inventoryID/data/inventory/${srcFileName_L1}_2021.gdb"

srcFileName_L2=${srcFileName}_L2_POLY
srcFullPath_L2="$friDir/BC/$inventoryID/data/inventory/${srcFileName_L2}_2021.gdb"
