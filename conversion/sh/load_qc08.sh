...
# This script loads the Quebec (QC08) into PostgreSQL
...
# QC08, QC09 and QC10 all come from the same FRI. Here we filter the full table to onl
...
srcFullPath="$friDir/QC/$inventoryID/data/inventory/$srcFileName.gpkg"

gdbFileName_poly=pee_maj
gdbFileName_meta=meta_maj

fullTargetTableName=$targetFRISchema.qc08
