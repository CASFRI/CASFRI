...
srcWater=$friDir/nb_0001/Waterbody.shp
srcNameWater=Waterbody
ogrTabWater=Waterbody

srcNonForest="$friDir/nb_0001/Non Forest.shp"
srcNameNonForest=NonForest
ogrTabNonForest='Non Forest'

srcWetland=$friDir/nb_0001/wetland.shp
srcNameWetland=wetland
ogrTabWetland=wetland

srcForest=$friDir/nb_0001/Forest.shp
