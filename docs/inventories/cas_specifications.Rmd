...
library(tidyverse)  
x0 = read_csv("../docs/specifications/attributes/cas_attribute_values.csv")  
x1 = read.csv("../docs/specifications/errors/cas_errors_general.csv")  
x2 = read_csv("../docs/specifications/errors/cas_errors_specific.csv")  
```  
