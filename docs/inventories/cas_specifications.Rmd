...
library(tidyverse)  
x0 = read_csv("../specifications/attributes/cas_attribute_values.csv")  
x1 = read.csv("../specifications/errors/cas_errors_general.csv")  
x2 = read_csv("../specifications/errors/cas_errors_specific.csv")  
```  
