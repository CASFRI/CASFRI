...
## productive_for {.tabset}
  ...
  * This attribute uses for_mgmt_land_base_ind to identify productive forest.
  * Previously, this was done using multiple attributes (see CAS_04 Perl code).
