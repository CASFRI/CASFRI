...
friConnect = function(inv) {
    ...
    if (inv=="ab06") {
        ...
        x = as_tibble(dbGetQuery(con, "SELECT ogc_fid, fst, l1cc, l1ht, l1s1, l1pr1, l1estyr, l1trt, l1trtyr, l1vs, l2cc, l2ht, l2s1, l2pr1, l2estyr, l2trt, l2trtyr, l2vs FROM rawfri.nb01"))
