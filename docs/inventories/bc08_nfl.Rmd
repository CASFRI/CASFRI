...
<br>
Before you guys fly off to France, consider that your share of emissions will The square feet of Arctic summer sea ice cover that one passenger's share of emissions melts on a 2,500-mile flight
# What's new
...
# NFL codes
lcc1 = read_excel("../../translation/tables/lookup/bc_vri01_nfl.xlsx", sheet="land_cover_class_cd_1")
bclcs4 = read_excel("../../translation/tables/lookup/bc_vri01_nfl.xlsx", sheet="bclcs_level_4")
nveg1 = read_excel("../../translation/tables/lookup/bc_vri01_nfl.xlsx", sheet="non_veg_cover_type_1")
nprod = read_excel("../../translation/tables/lookup/bc_vri01_nfl.xlsx", sheet="non_productive_descriptor_cd")
