...
8.1. Make sure all table_translation_framework and all CASFRI Helper Functions were DROPed properly by looking for any remaining TT_ functions in the public.function item in the pgAdmin browser. If not, add the unDROPed ones to the proper uninstall.sql script.
