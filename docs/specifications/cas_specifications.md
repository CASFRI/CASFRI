...
position. A projection is a systematic construction of lines drawn on
a  
...
inventories called Phase 1, Phase 2, and Phase 3. As inventories
became  
...
same. Several years of successive or periodic acquisition are
possible;  
...
Guide to the Vegetation Resources Inventory. Timberline Forest
Inventory  
Consultants.
...
Standards Manual, Version 2.1. Resource Data Division. Data
Acquisition  
Branch.
...
Manual. Internal Document prepared by Timberline Natural Resource
Group  
Ltd. 
...
Forest Vegetation Inventory Standards with Softcopy Supplements,
Version  
...
<br>
  ...
  - Appendix 3 Stand Structure - Summary of Canadian Forest
    Inventories  
