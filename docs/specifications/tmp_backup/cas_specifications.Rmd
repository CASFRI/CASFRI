...
library(tidyverse)  
x = read_csv("attributes/cas_attribute_values.csv")  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="STAND_STRUCTURE_PER and STAND_STRUCTURE_RANGE") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="LAYER") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="LAYER_RANK") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="SOIL_MOIST_REG") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="CROWN_CLOSURE_UPPER and CROWN_CLOSURE_LOWER") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="HEIGHT_UPPER and HEIGHT_LOWER") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="SPECIES_1 ... SPECIES_10") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="SPECIES_PER_1 ... SPECIES_PER_10") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="ORIGIN_UPPER and ORIGIN_LOWER") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="SITE_CLASS") %>% select(Description, Value)  
...
```{r echo=FALSE, message=FALSE, warning=FALSE}  
y = x %>% filter(Attribute=="SITE_INDEX") %>% select(Description, Value)  
